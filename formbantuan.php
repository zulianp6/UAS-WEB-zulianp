...
<body> 
	...
	<fieldset>
		...
		<form class="form-horizontal shadow p-3 mb-5 bg-body rounded">
			<legend>Bantuan, Kritik, dan Saran</legend><br>
...
<input type="text" id="email"><br><br> -->
		<div class="form-group row">
			<button type="button" id="tambahpesan" class="btn btn-success col-form">TAMBAH</button>
			<button onclick="window.location.href='../home3.html'" class="btn btn-success col-form">BACK TO HOME</a></button>
			<span id="status"></span>
		</div> </form> </fieldset>
